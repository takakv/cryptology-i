...
\begin{solution}
    \begin{quote}
        ...
        unbreakable, i.e., signatures are unforgeable.
        ...
        Unlike with a One Time Pad, guaranteed correctness of brute force is
        ...
        original plaintext''} cannot be mathematically achieved.
