...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        As such, from (b), for any message $m$ we can construct a message $m'$
        that satisfies (a), and thus second preimage-resistance is broken for
        messages of length $l\ge2$.\qed
    \end{enumerate}
\end{solution}
\end{document}
